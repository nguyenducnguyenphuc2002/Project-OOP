...
public class LoadTileMap {
    ...
    public static void loadTileMap(TileMap tileMap, String mapName, String tilesName){
        tileMap.loadTiles(new File("D:/Assignments/Project-OOP/Disanour_Tale/src/resources/"+tilesName));
        tileMap.loadMap(new File("D:/Assignments/Project-OOP/Disanour_Tale/src/resources/"+mapName));
